...
sudo cp ${TOOLCHAIN_DIR}/../aarch64-none-linux-gnu/libc/lib/ld-linux-aarch64.* ${OUTDIR}/rootfs/lib
sudo cp ${TOOLCHAIN_DIR}/../aarch64-none-linux-gnu/libc/lib64/libm.so.* ${OUTDIR}/rootfs/lib64
sudo cp ${TOOLCHAIN_DIR}/../aarch64-none-linux-gnu/libc/lib64/libresolv.so.* ${OUTDIR}/rootfs/lib64
sudo cp ${TOOLCHAIN_DIR}/../aarch64-none-linux-gnu/libc/lib64/libc.so.* ${OUTDIR}/rootfs/lib64
sudo cp ${TOOLCHAIN_DIR}/../aarch64-none-linux-gnu/libc/usr/lib64/libstdc++.so.* ${OUTDIR}/rootfs/lib64
sudo cp ${TOOLCHAIN_DIR}/../aarch64-none-linux-gnu/libc/usr/lib64/libgcc*.so.** ${OUTDIR}/rootfs/lib64
